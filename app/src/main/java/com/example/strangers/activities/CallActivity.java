        ...
        FirebaseDatabase.getInstance().getReference()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (currentUser != null) {
                            Glide.with(CallActivity.this).load(currentUser.getProfile()).into((ImageView) findViewById(R.id.profile));
                            ((TextView) findViewById(R.id.name)).setText(currentUser.getName());
                            ((TextView) findViewById(R.id.city)).setText(currentUser.getCity());
                        }
                    }
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            ...
                            if (user != null) {
                                ...
                                Toast.makeText(CallActivity.this, "User profile not found", Toast.LENGTH_SHORT).show();
                            }
                        }
